...
<div class="max-w-md mx-auto bg-white rounded-xl shadow p-8">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="password" name="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required>
        </div>
        <button type="submit" class="w-full py-2.5 rounded-lg bg-indigo-600 text-white font-medium hover:bg-indigo-700">Registrarme</button>
    </form>
    <!-- Enlace a la página de inicio de sesión -->
    <p class="text-sm text-gray-600 mt-6">¿Ya tienes cuenta?
        <a class="text-indigo-600 hover:underline" href="/">Iniciar sesión</a>
    </p>
